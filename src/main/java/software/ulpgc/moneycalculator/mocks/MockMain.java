...
public class MockMain {
    public static void main(String[] args) {
        ...
        ExchangeRateLoader exchangeRateLoader = new MockExchangeRate();
        Command command = new ExangeMoneyProcesCommand(moneyDialog, currencyDialog, exchangeRateLoader, moneyDisplay);
        command.execute();
    }
}
